...
const Service = () => {
  return (
    <>
      {/* <section className=" px-4 mt-20 mb-12 mx-auto max-w-7xl sm:px-6 lg:px-8  ">
        ...
        <div className="px-4 py-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-12 text-left sm:grid-cols-2 md:grid-cols-4 lg:gap-y-16">
            <div className="hover:scale-105 transition-transform transform-gpu ">
              <Link href="/services/web-development">
                <div className="relative flex items-center justify-start mx-auto">
                  <svg
      ...
      <section className="py-8 sm:py-8 lg:py-12">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-2xl mx-auto text-center">
            ...
            What we offer to grow you <span className="text-primary">Real Estate</span>
            </h2>
          </div>
