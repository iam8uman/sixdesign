            ...
            <div className="space-y-4 sm:space-y-8">
              <div className="overflow-hidden bg-white shadow-md rounded-xl">
                <div className="p-9">
                  ...
                  <p className="mt-6 text-base text-gray-600 font-pj">
                    ...
                    Eleifend nullam consectetur placerat pellentesque ut massa
              ...
              <div className="overflow-hidden bg-white shadow-md rounded-xl">
                <div className="p-9">
                  ...
                  <p className="mt-6 text-base text-gray-600 font-pj">
                    Eleifend nullam consectetur placerat pellentesque ut massa
                    volutpat at. Diam pretium orci dui sagittis. Norem ipsum
              ...
              <div className="relative">
                ...
                <div className="relative overflow-hidden bg-white shadow-md rounded-xl">
                  <div className="p-9">
                    ...
                    <p className="mt-6 text-base text-gray-600 font-pj">
                      Eleifend nullam consectetur placerat pelle tesque ut massa
                      volutpat bonur los.
                    </p>
                  </div>
                </div>
